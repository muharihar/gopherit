...
func NewApp() (a App) {
	...
	_ = makeCommand("help", func(command *cobra.Command, i []string) { command.Help() }, vcmd)
	...
	_ = makeCommand("help", func(command *cobra.Command, i []string) { command.Help() }, ccmd)
	...
	_ = makeCommand("help", func(command *cobra.Command, i []string) { command.Help() }, scmd)
